...
# Note: ricl_step_offset is baked into the model config (e.g. pi0_fast_libero_ricl_step5_offset).
# Set RICL_STEP_OFFSET to override at inference (ablation only) — leave unset to use the config value.
# export RICL_STEP_OFFSET=10
